...
document.addEventListener('DOMContentLoaded', () => {
    const initialize = async () => {
        ...
        // Implement a loading manager for progress tracking
        ...
        manager.onProgress = (url, itemsLoaded, itemsTotal) => {
            ...
            // Add a progress bar or loading indicator here
        };
        manager.onLoad = () => {
            console.log('Loading complete!');
        };

        // Load a Draco-compressed GLTF model for faster loading
        const loader = new THREE.GLTFLoader(manager);
        const dracoLoader = new DRACOLoader();
        dracoLoader.setDecoderPath('../libs/DRACOLoader.js');
        loader.setDRACOLoader(dracoLoader);

        const model = await loader.loadAsync('../assets/models/coffee-table/scene_draco.gltf');
